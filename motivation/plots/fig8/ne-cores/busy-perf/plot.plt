...
plot \
    in1 every ::0::0 using (0):1 with boxes lc rgb "#888888" notitle, \
    ''  every ::1::1 using (1):1 with boxes lc rgb "#bbbbbb" notitle, \
    ''  every ::2::2 using (2):1 with boxes lc rgb "#555555" notitle
