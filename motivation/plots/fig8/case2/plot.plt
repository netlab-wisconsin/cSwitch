...
plot in1 using (column("same-core")):xtic(1) title "Core-Aff."    with histograms fill pattern 1, \
     ''  using (column("same-llc"))          title "Chiplet-Aff." with histograms fill pattern 2, \
     ''  using (column("optimal"))           title "Oracle"       with histograms fill pattern 3
