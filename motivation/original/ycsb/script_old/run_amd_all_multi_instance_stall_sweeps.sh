...
combined_dir="${RESULTS_DIR}/amd_all_backends_multi_instance_${host}_${now}_$$"
...
run_rocksdb_multi_instance_sweep "amd" "${NO_RETIRED_INST_EVENT_NAME}" "${NO_RETIRED_INST_PERF_EVENT}"
...
run_orientdb_multi_instance_sweep "amd" "${NO_RETIRED_INST_EVENT_NAME}" "${NO_RETIRED_INST_PERF_EVENT}"
summary_files+=("${LAST_MULTI_INSTANCE_SUMMARY_FILE}")
instance_summary_files+=("${LAST_MULTI_INSTANCE_INSTANCE_SUMMARY_FILE}")
